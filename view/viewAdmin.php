...
include_once "../controller/updateAdmin.php";
include_once "../controller/viewAdmin.php";
if (isset($_GET["oid"]))
    $data = viewAdmin($_GET["oid"]);
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    <div class="main">
        ...
        <div class="card">
            <div class="card-body">
                <a class="btn btn-primary btn-left" href="editAdmin.php?oid=<?php echo $data['oid'] ?>">Edit</a> <a class="btn btn-danger btn-left" href="../controller/deleteAdmin.php?o-id=<?php echo $data['oid'] ?>">Delete</a></td>
